...
export class AppConfig {
  ...
  private getBooleanEnvVar(variableName: string, defaultValue?: boolean): boolean {
  ...
  private getIntegerEnvVar(variableName: string, defaultValue?: number): number {
    const value = this.getEnvVar(variableName, defaultValue ?? null);
  ...
  private getEnvVar(variableName: string, defaultValue: boolean | number | string | null): string {
